function init() {
    ...
    //1
    drop1.addEventListener('dragenter', function(e){ e.preventDefault(); }, false);
    drop1.addEventListener('dragover', function(e){ e.preventDefault(); }, false);
    drop1.addEventListener('drop', soltado, false);

    //2
    drop2.addEventListener('dragenter', function(e){ e.preventDefault(); }, false);
    drop2.addEventListener('dragover', function(e){ e.preventDefault(); }, false);
    drop2.addEventListener('drop', soltado2, false);

    //3
    drop3.addEventListener('dragenter', function(e){ e.preventDefault(); }, false);
    drop3.addEventListener('dragover', function(e){ e.preventDefault(); }, false);
